...
(1,1,2,0,0,'2020-12-28 20:56:30','2020-12-28 20:56:32',0,'.','테스트 게시물.'),
(2,1,1,0,0,'2020-12-21 08:58:22','2020-12-21 08:58:27',0,'공지사항','## 안녕하세요 블로그 주인 방혜성 입니다.\r\n앞으로 제 공부 내용들이 올라올 사이트입니다.'),
(3,1,4,0,0,'2020-12-21 09:03:49','2020-12-21 09:03:50',0,'JAVA IF문','if는 조건을 비교하고 그에 따른 결과를 내줍니다.\r\nelse는 if의 조건과 맞지 않을 때 else에 들어간 값을 반환하고\r\nelse if는 if의 조건이 아닐 때 여러개의 값을 줄 수 있습니다.\r\n```codepen\r\nhttps://codepen.io/hyeseong123/embed/RwGLpEm?height=265&theme-id=light&default-tab=js,result&editable=true\r\n```'),
...
(19,1,3,0,0,'2020-12-29 22:38:49','2020-12-29 22:38:50',0,'테스트 게시물2','123'),
(20,1,3,0,0,'2020-12-29 22:39:10','2020-12-29 22:39:12',0,'테스트 게시물3','123');
...
(2,'2020-12-21 09:16:13','2020-12-21 09:16:13','? 공부게시판 ?','? 공부게시판 ?'),
(3,'2020-12-21 09:16:26','2020-12-21 09:16:26','? 자유게시판 ?','? 자유게시판 ?'),
(4,'2020-12-28 17:22:39','2020-12-28 17:22:12','자바','공부게시판 - 자바'),
(5,'2020-12-28 20:07:07','2020-12-28 20:07:10','웹','공부게시판 - 웹'),
